...
const en = {
  ...
  library: {
    ...
    asanas: {
      primarySeries: 'Primary Series',
      primarySub: 'Yoga Chikitsa',
      intermediateSeries: 'Intermediate',
      intermediateSub: 'Nadi Shodhana',
      searchPrimary: 'Search primary asanas…',
      searchIntermediate: 'Search intermediate asanas…',
      all: 'All',
      noResults: 'No asanas match "{{query}}"',
      vinyasas: 'vinyasas',
      ...
      sections: {
        'Opening': 'Opening',
        'Standing': 'Standing',
        'Primary Seated': 'Primary Seated',
        'Finishing': 'Finishing',
        'Pashasana Group': 'Pashasana Group',
        'Backbend Series': 'Backbend Series',
        'Leg Behind Head Prep': 'Leg Behind Head Prep',
        'Leg Behind Head': 'Leg Behind Head',
        'Arm Balance Series': 'Arm Balance Series',
        'Hip Openers': 'Hip Openers',
        'Advanced Inversions': 'Advanced Inversions',
      },
    },
    sequences: {

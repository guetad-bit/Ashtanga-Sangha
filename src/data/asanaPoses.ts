...
export const PRIMARY_POSE_SEQUENCE: AsanaPose[] = [
  ...
  { id: 'sirsasana_a', sanskrit: 'Śīrṣāsana A', english: 'Headstand', series: 'Finishing', benefits: ['Focus', 'Core', 'Inversion'], tips: 'The king of asanas. Foundation in forearms. Hold 25 breaths.', breaths: 25, sides: 'Center', difficulty: 'Adv.', image: images.sirsasana_b },

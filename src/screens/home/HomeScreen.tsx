...
const FAKE_USERS: {
  ...
  { id: 'fake-noa', name: 'Noa Levi', avatarUrl: 'https://i.pravatar.cc/150?img=1', series: 'primary', streak: 142, practicedToday: true, bio: 'Yoga teacher. 6 years of Ashtanga practice at a shala in Tel Aviv.', badge: 'streak', badgeText: '142 days', feedCaption: 'Perfect morning practice 🌅 Primary series flowed beautifully today', feedImage: 'https://images.unsplash.com/photo-1470114716159-e389f8712861?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 2 * 3600000).toISOString(), feedLikes: 12, feedComments: 3 },
  { id: 'fake-ori', name: 'Ori Cohen', avatarUrl: 'https://i.pravatar.cc/150?img=3', series: 'primary', streak: 8, practicedToday: true, bio: 'Software developer. Started Ashtanga 8 months ago. Still working on seated postures.', badge: 'practiced', badgeText: 'Today', feedCaption: 'Finally caught my toes in Janu Sirsasana! 🎉', feedImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 5 * 3600000).toISOString(), feedLikes: 18, feedComments: 7 },
  { id: 'fake-michal', name: 'Michal Avraham', avatarUrl: 'https://i.pravatar.cc/150?img=5', series: 'intermediate', streak: 365, practicedToday: true, bio: 'Psychologist, mother of three. 12 years of practice. Started with Pattabhi Jois.', badge: 'streak', badgeText: '1 year', feedCaption: 'Kapotasana — every day is a new beginning. The breath is the key 🙏', feedImage: 'https://images.unsplash.com/photo-1518241353330-0f7941c2d9b5?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 8 * 3600000).toISOString(), feedLikes: 24, feedComments: 5 },
  { id: 'fake-yotam', name: 'Yotam Barak', avatarUrl: 'https://i.pravatar.cc/150?img=8', series: 'sun_sals', streak: 21, practicedToday: false, bio: 'Diving instructor in Eilat. Practices on the beach at sunrise.', badge: 'practiced', badgeText: 'Yesterday', feedCaption: 'Sun salutations on the reef beach 🌊☀️ Nothing like practicing with sand under your feet', feedImage: 'https://images.unsplash.com/photo-1476673160081-cf065607f449?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 18 * 3600000).toISOString(), feedLikes: 31, feedComments: 9 },
  { id: 'fake-rinat', name: 'Rinat Shimoni', avatarUrl: 'https://i.pravatar.cc/150?img=9', series: 'primary', streak: 56, practicedToday: true, bio: 'Architect from Haifa. Home practitioner for 4 years.', badge: 'streak', badgeText: '56 days', feedCaption: 'Discovered that aligning the hips in Trikonasana changes everything', feedImage: 'https://images.unsplash.com/photo-1495364141860-b0d03eccd065?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 3 * 3600000).toISOString(), feedLikes: 8, feedComments: 2 },
  { id: 'fake-daniel', name: 'Daniel Friedman', avatarUrl: 'https://i.pravatar.cc/150?img=11', series: 'primary', streak: 34, practicedToday: false, bio: 'Chef and restaurant owner. Practices at 10am after night shifts.', badge: 'practiced', badgeText: 'Yesterday', feedCaption: 'Late practice + healthy breakfast = perfect day 🍳🧘‍♂️', feedImage: 'https://images.unsplash.com/photo-1484723091739-30a097e8f929?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 26 * 3600000).toISOString(), feedLikes: 15, feedComments: 4 },
  { id: 'fake-talia', name: 'Talia Wolf', avatarUrl: 'https://i.pravatar.cc/150?img=10', series: 'short', streak: 89, practicedToday: true, bio: 'Organic farmer in the Galilee. Mother of 4. Adapting practice to the rhythm of life.', badge: 'streak', badgeText: '89 days', feedCaption: '40-minute practice between the garden and the barn. That is all you need 🌿', feedImage: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 4 * 3600000).toISOString(), feedLikes: 22, feedComments: 6 },
  { id: 'fake-ido', name: 'Ido Nachum', avatarUrl: 'https://i.pravatar.cc/150?img=12', series: 'primary', streak: 512, practicedToday: true, bio: 'Family doctor. 18 years of practice. Travels to Mysore every two years.', badge: 'streak', badgeText: '512 days', feedCaption: 'After 18 years, Supta Kurmasana still teaches me something new every time', feedImage: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 6 * 3600000).toISOString(), feedLikes: 35, feedComments: 11 },
  { id: 'fake-shira', name: 'Shira Mizrahi', avatarUrl: 'https://i.pravatar.cc/150?img=16', series: 'sun_sals', streak: 3, practicedToday: false, bio: 'Art student. 3 months into Ashtanga. Draws postures in her sketchbook.', badge: 'practiced', badgeText: '3 days ago', feedCaption: 'Drew Virabhadrasana B today 🎨 Who wants to see?', feedImage: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 48 * 3600000).toISOString(), feedLikes: 27, feedComments: 8 },
  { id: 'fake-amir', name: 'Amir Hadad', avatarUrl: 'https://i.pravatar.cc/150?img=13', series: 'primary', streak: 12, practicedToday: true, bio: 'Lawyer and new dad. Trying to keep up the routine with a baby at home.', badge: 'practiced', badgeText: 'Today', feedCaption: 'Baby woke up mid-Navasana. Did the rest with her on my belly 😂', feedImage: 'https://images.unsplash.com/photo-1492725764893-90b379c2b6e7?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 1 * 3600000).toISOString(), feedLikes: 42, feedComments: 14 },
  { id: 'fake-sarah', name: 'Sarah Mitchell', avatarUrl: 'https://i.pravatar.cc/150?img=20', series: 'primary', streak: 204, practicedToday: true, bio: 'Yoga teacher in London. Spent 3 months in Mysore with Sharath.', badge: 'streak', badgeText: '204 days', feedCaption: 'Morning Mysore at the shala. Nothing beats the energy of practicing together 🕉️', feedImage: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 7 * 3600000).toISOString(), feedLikes: 19, feedComments: 4 },
  { id: 'fake-david', name: 'David Stern', avatarUrl: 'https://i.pravatar.cc/150?img=14', series: 'intermediate', streak: 730, practicedToday: true, bio: 'Former Wall Street trader, now full-time yoga teacher in Brooklyn. 15 years of practice.', badge: 'streak', badgeText: '2 years', feedCaption: 'Kapo day. The backbend that changed everything. Trust the breath. 🔥', feedImage: 'https://images.unsplash.com/photo-1446776899648-aa78eefe8ed0?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 10 * 3600000).toISOString(), feedLikes: 28, feedComments: 6 },
];
...
const s = StyleSheet.create({
  ...
  weekDays: { flexDirection: 'row' as any, justifyContent: 'space-around' as any, marginBottom: 14 },
  weekDayCol: { alignItems: 'center' as any, gap: 5 },
  weekDayLabel: { fontFamily: 'DMSans_500Medium', fontSize: 13, color: moss.muted },
  weekDayCircle: {
  ...
  goalBig: {
    ...
    fontWeight: '700' as any, color: moss.ink, lineHeight: 26,
  },
  goalSlash: { fontSize: 14, color: moss.muted },
  goalSmall: { fontSize: 14, color: moss.muted },
  goalLabel: { fontSize: 14, color: moss.ink, fontWeight: '500' as any },
  progressBar: {
    width: '100%' as any, height: 6, borderRadius: 3,

...
const FAKE_USERS: {
  ...
  { id: 'fake-noa', name: 'Noa Levi', avatarUrl: 'https://i.pravatar.cc/150?img=1', series: 'primary', streak: 142, practicedToday: true, bio: 'Yoga teacher. 6 years of Ashtanga practice at a shala in Tel Aviv.', badge: 'streak', badgeText: '142 days', feedCaption: 'Perfect morning practice 🌅 Primary series flowed beautifully today', feedImage: 'https://images.unsplash.com/photo-1575052814086-f385e2e2ad33?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 2 * 3600000).toISOString(), feedLikes: 12, feedComments: 3 },

...
const FAKE_USERS: {
  ...
  { id: 'fake-noa', name: 'Noa Levi', avatarUrl: 'https://i.pravatar.cc/150?img=1', series: 'primary', streak: 142, practicedToday: true, bio: 'Yoga teacher. 6 years of Ashtanga practice at a shala in Tel Aviv.', badge: 'streak', badgeText: '142 days', feedCaption: 'Perfect morning practice 🌅 Primary series flowed beautifully today', feedImage: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 2 * 3600000).toISOString(), feedLikes: 12, feedComments: 3 },
  ...
  { id: 'fake-michal', name: 'Michal Avraham', avatarUrl: 'https://i.pravatar.cc/150?img=5', series: 'intermediate', streak: 365, practicedToday: true, bio: 'Psychologist, mother of three. 12 years of practice. Started with Pattabhi Jois.', badge: 'streak', badgeText: '1 year', feedCaption: 'Kapotasana — every day is a new beginning. The breath is the key 🙏', feedImage: 'https://images.unsplash.com/photo-1588286840104-8957b019727f?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 8 * 3600000).toISOString(), feedLikes: 24, feedComments: 5 },
  ...
  { id: 'fake-rinat', name: 'Rinat Shimoni', avatarUrl: 'https://i.pravatar.cc/150?img=9', series: 'primary', streak: 56, practicedToday: true, bio: 'Architect from Haifa. Home practitioner for 4 years.', badge: 'streak', badgeText: '56 days', feedCaption: 'Home practice corner ready. Mat down, incense lit, phone off', feedImage: 'https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 3 * 3600000).toISOString(), feedLikes: 8, feedComments: 2 },
  ...
  { id: 'fake-talia', name: 'Talia Wolf', avatarUrl: 'https://i.pravatar.cc/150?img=10', series: 'short', streak: 89, practicedToday: true, bio: 'Organic farmer in the Galilee. Mother of 4. Adapting practice to the rhythm of life.', badge: 'streak', badgeText: '89 days', feedCaption: '40-minute practice between the garden and the barn. That is all you need 🌿', feedImage: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 4 * 3600000).toISOString(), feedLikes: 22, feedComments: 6 },
  ...
  { id: 'fake-shira', name: 'Shira Mizrahi', avatarUrl: 'https://i.pravatar.cc/150?img=16', series: 'sun_sals', streak: 3, practicedToday: false, bio: 'Art student. 3 months into Ashtanga. Draws postures in her sketchbook.', badge: 'practiced', badgeText: '3 days ago', feedCaption: 'Drew Virabhadrasana B today 🎨 Who wants to see?', feedImage: 'https://images.unsplash.com/photo-1552196563-55cd4e45efb3?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 48 * 3600000).toISOString(), feedLikes: 27, feedComments: 8 },
  ...
  { id: 'fake-david', name: 'David Stern', avatarUrl: 'https://i.pravatar.cc/150?img=14', series: 'intermediate', streak: 730, practicedToday: true, bio: 'Former Wall Street trader, now full-time yoga teacher in Brooklyn. 15 years of practice.', badge: 'streak', badgeText: '2 years', feedCaption: 'Kapo day. The backbend that changed everything. Trust the breath. 🔥', feedImage: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 10 * 3600000).toISOString(), feedLikes: 28, feedComments: 6 },
];

...
const FAKE_USERS: {
  ...
  { id: 'fake-noa', name: 'Noa Levi', avatarUrl: 'https://i.pravatar.cc/150?img=1', series: 'primary', streak: 142, practicedToday: true, bio: 'Yoga teacher. 6 years of Ashtanga practice at a shala in Tel Aviv.', badge: 'streak', badgeText: '142 days', feedCaption: 'Perfect morning practice 🌅 Primary series flowed beautifully today', feedImage: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 2 * 3600000).toISOString(), feedLikes: 12, feedComments: 3 },
  { id: 'fake-ori', name: 'Ori Cohen', avatarUrl: 'https://i.pravatar.cc/150?img=3', series: 'primary', streak: 8, practicedToday: true, bio: 'Software developer. Started Ashtanga 8 months ago. Still working on seated postures.', badge: 'practiced', badgeText: 'Today', feedCaption: 'Finally caught my toes in Janu Sirsasana! 🎉', feedImage: '', feedTime: new Date(Date.now() - 5 * 3600000).toISOString(), feedLikes: 18, feedComments: 7 },
  { id: 'fake-michal', name: 'Michal Avraham', avatarUrl: 'https://i.pravatar.cc/150?img=5', series: 'intermediate', streak: 365, practicedToday: true, bio: 'Psychologist, mother of three. 12 years of practice. Started with Pattabhi Jois.', badge: 'streak', badgeText: '1 year', feedCaption: 'Kapotasana — every day is a new beginning. The breath is the key 🙏', feedImage: '', feedTime: new Date(Date.now() - 8 * 3600000).toISOString(), feedLikes: 24, feedComments: 5 },
  ...
  { id: 'fake-daniel', name: 'Daniel Friedman', avatarUrl: 'https://i.pravatar.cc/150?img=11', series: 'primary', streak: 34, practicedToday: false, bio: 'Chef and restaurant owner. Practices at 10am after night shifts.', badge: 'practiced', badgeText: 'Yesterday', feedCaption: 'Late practice + healthy breakfast = perfect day 🍳🧘‍♂️', feedImage: '', feedTime: new Date(Date.now() - 26 * 3600000).toISOString(), feedLikes: 15, feedComments: 4 },
  { id: 'fake-talia', name: 'Talia Wolf', avatarUrl: 'https://i.pravatar.cc/150?img=10', series: 'short', streak: 89, practicedToday: true, bio: 'Organic farmer in the Galilee. Mother of 4. Adapting practice to the rhythm of life.', badge: 'streak', badgeText: '89 days', feedCaption: '40-minute practice between the garden and the barn. That is all you need 🌿', feedImage: '', feedTime: new Date(Date.now() - 4 * 3600000).toISOString(), feedLikes: 22, feedComments: 6 },
  { id: 'fake-ido', name: 'Ido Nachum', avatarUrl: 'https://i.pravatar.cc/150?img=12', series: 'primary', streak: 512, practicedToday: true, bio: 'Family doctor. 18 years of practice. Travels to Mysore every two years.', badge: 'streak', badgeText: '512 days', feedCaption: 'After 18 years, Supta Kurmasana still teaches me something new every time', feedImage: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&h=400&fit=crop', feedTime: new Date(Date.now() - 6 * 3600000).toISOString(), feedLikes: 35, feedComments: 11 },
  { id: 'fake-shira', name: 'Shira Mizrahi', avatarUrl: 'https://i.pravatar.cc/150?img=16', series: 'sun_sals', streak: 3, practicedToday: false, bio: 'Art student. 3 months into Ashtanga. Draws postures in her sketchbook.', badge: 'practiced', badgeText: '3 days ago', feedCaption: 'Drew Virabhadrasana B today 🎨 Who wants to see?', feedImage: '', feedTime: new Date(Date.now() - 48 * 3600000).toISOString(), feedLikes: 27, feedComments: 8 },
  { id: 'fake-amir', name: 'Amir Hadad', avatarUrl: 'https://i.pravatar.cc/150?img=13', series: 'primary', streak: 12, practicedToday: true, bio: 'Lawyer and new dad. Trying to keep up the routine with a baby at home.', badge: 'practiced', badgeText: 'Today', feedCaption: 'Baby woke up mid-Navasana. Did the rest with her on my belly 😂', feedImage: '', feedTime: new Date(Date.now() - 1 * 3600000).toISOString(), feedLikes: 42, feedComments: 14 },
